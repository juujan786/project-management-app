        ...
        <div>
          ...
          {isSideBarOpen && (
            <div className=" bg-white  dark:bg-[#2b2c37]  w-full   py-4 rounded-xl">
              ...
              <div className="dropdown-borad flex flex-col">
                <div
                ...
                <div className="projects overflow-y-auto">
                  {boards.map((board, index) => (
                    <div
                      className={`flex items-baseline space-x-2 px-5 mr-8 mt-2 rounded-r-full duration-500 ease-in-out py-4 cursor-pointer hover:bg-[#635fc71a] hover:text-[#635fc7] dark:hover:bg-white dark:hover:text-[#635fc7] dark:text-white  ${
                        board.isActive &&
          ...
          {isSideBarOpen ? (
            <div
              ...
              className=" hidden   items-center mt-2  absolute bottom-16  text-lg font-bold  rounded-r-full hover:text-[#635FC7] cursor-pointer mr-6 mb-8 px-8 py-4 hover:bg-[#635fc71a] dark:hover:bg-white  space-x-2 justify-center  my-4 text-gray-500 "
            >
              <img
